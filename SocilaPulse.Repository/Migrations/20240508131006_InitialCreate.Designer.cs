...
namespace SocialPulse.Repository.Migrations
{
    ...
    [Migration("20240508131006_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialPulse.Core.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SocialPulse.Core.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SocialPulse.Core.Models.Comment", b =>
                {
                    b.HasOne("SocialPulse.Core.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("SocialPulse.Core.Models.Friend", b =>
                {
                    b.HasOne("SocialPulse.Core.Models.User", "Addressee")
                        .WithMany()
                        .HasForeignKey("AddresseeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SocialPulse.Core.Models.User", "Requester")
                        .WithMany()
